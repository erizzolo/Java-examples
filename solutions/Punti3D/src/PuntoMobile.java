...
/**
 * Classe derivata che rappresenta un punto mobile nello spazio tridimensionale,
...
public class PuntoMobile extends Punto {
    ...
    /**
     * x, y and z distance from "home": actual displacement from original position
     */
     ...
     */
    public PuntoMobile(double x, double y, double z) {
        super(x, y, z);
        debug("-> PuntoMobile(" + x + ", " + y + ", " + z + ") (after super(x,y,z)!!!)");
     ...
     * @param dz z axis movement
     */
    public void move(double dx, double dy, double dz) {
        this.dx += dx;
        this.dy += dy;
        this.dz += dz;
        travelledDistance += Math.hypot(Math.hypot(dx, dy), dz);
    ...
    public PuntoMobile getSymmetric() {
        return new PuntoMobile(-getX(), -getY(), -getZ());
    }
    ...
    public static PuntoMobile getRandom() {
        ...
        result = new PuntoMobile(result.getX(), result.getY(), result.getZ());
        debug("getRandom() ->");
    ...
    public static PuntoMobile test() {
        ...
        PuntoMobile p = new PuntoMobile(1.5, 2.5, 3.5);
        System.out.println("p = new PuntoMobile(1.5, 2.5, 3.5): " + p);
        Punto r = getRandom();
        ...
        System.out.println("Moving p to the origin: p.move(-p.getX(), -p.getY(), -p.getZ());");
        p.move(-p.getX(), -p.getY(), -p.getZ());
