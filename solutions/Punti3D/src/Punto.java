...
public class Punto {
     ...
     */
    public static final Punto ORIGIN = new Punto(0.0, 0.0, 0.0);
    /**
    ...
    public static Punto getMedio(Punto first, Punto second) {
        ...
        Punto result = new Punto((first.x + second.x) / 2, (first.y + second.y) / 2, (first.z + second.z) / 2);
        debug("getMedio(" + first + ", " + second + ") ->");
        return result;
    }
    ...
    public static Punto getRandom() {
        debug("-> getRandom()");
        Punto result = new Punto(RANDOM.nextGaussian(), RANDOM.nextGaussian(), RANDOM.nextGaussian());
        debug("getRandom() ->");
        return result;
    }
    ...
    /**
     * Get the value of the z coordinate of this Punto
     *
    ...
    public double getDistanceFrom(Punto other) {
        return other == null ? Double.NaN
                : Math.hypot(Math.hypot(getX() - other.getX(), getY() - other.getY()), getZ() - other.getZ());
    }
    ...
    public String toString() {
        return super.toString() + "[x=" + getX() + ", y=" + getY() + ", z=" + getZ() + "]";
    }
    ...
    public static Punto test() {
        ...
        Punto p = new Punto(1.5, 2.5, 3.5);
        System.out.println("p = new Punto(1.5, 2.5, 3.5): " + p);
        Punto r = getRandom();
